...
class PriorityExperienceReplay(object):
    ...
    '''
    This class implements priority experience buffer. Based on priority and importance of each experience, a data structure is maintained.
    '''
    ...
    def __init__(self, buffer_size, embedding_dim):
        ...
        self.actions = np.zeros((buffer_size, embedding_dim), dtype=np.int)
